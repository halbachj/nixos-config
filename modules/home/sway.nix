...
let
  ...
  in {
    ...
    home.packages = with pkgs; [
      tesseract4 waybar dmenu-wayland ulauncher wofi wofi-emoji slurp grim swappy swaylock-effects notify-desktop mako libappindicator 
    ];
}
